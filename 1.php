...
<html lang="en">
    <head>
        ...
        <title>Subḥāna Mawlid - 1. Assalaamu Alaika Zainal Anbiya'i</title>
  	...
  	<body class="d-flex text-center bg-dark">    
		<div class="cover-container d-flex w-100 mx-auto flex-column text-white">
		  	...
		  	<main class="px-3">
	    		<br><br>
	    		<h1 class="text-info"><a href="0.php" class="btn btn-light"><i class="bi bi-caret-left-fill"></i></a>&nbsp;<span class="arabic">اَلسَّلَامُ عَليْكَ زَيْنَ الْأَنْۢبِيَآءِ</span>&nbsp;<a href="2.php" class="btn btn-light"><i class="bi bi-caret-right-fill"></i></a></h1>
				<br>
