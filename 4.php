...
<html lang="en">
    <head>
        ...
        <title>Subḥāna Mawlid - 4. Maa Zaala Noor Muhammadin Mutanaqqila</title>
  	...
  	<body class="d-flex text-center bg-dark">    
		<div class="cover-container d-flex w-100 mx-auto flex-column text-white">
		  	<header class="mb-auto">
		    	<div>
		      		...
		      		<nav class="nav nav-masthead justify-content-center float-md-end">
		      			<a class="nav-link fw-bold py-1 px-0 active" href="0.php"><i class="bi bi-caret-left-fill"></i> Previous</a>
						...
						&emsp;<a class="nav-link fw-bold py-1 px-0 active" href="0.php">Next <i class="bi bi-caret-right-fill"></i></a> 
		      		</nav>
		    	</div>
		  	</header>
		  	...
		  	<main class="px-3">
	    		<br><br>
	    		<h1 class="text-info"><a href="0.php" class="btn btn-light"><i class="bi bi-caret-left-fill"></i></a>&nbsp;<span class="arabic">شعر</span>&nbsp;<a href="2.php" class="btn btn-light"><i class="bi bi-caret-right-fill"></i></a></h1>
				<br>
		    	<!-- <p class="lead">Cover is a one-page template for building simple and beautiful home pages. Download, edit the text, and add your own fullscreen background photo to make it your own.</p> -->
			    <?php 
			    	$handle = fopen("txt/4.txt", "r");
			    	$translation = fopen("txt/4.translation.txt", "r");
					if ($handle) {
						$num = 0;
					    while ($line = trim(fgets($handle))) {
					    	echo "<p class='arabic verse'>".$line."</p>";
					    	echo "<span class='translation'>".trim(fgets($translation))."</span><br class='translation'>";
